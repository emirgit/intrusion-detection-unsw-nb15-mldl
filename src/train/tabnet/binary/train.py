"""Train TabNet for binary classification on UNSW-NB15."""
...
class TabNetBinaryTrainer(ClassifierTrainer):
    def __init__(self, n_features, num_classes=1, class_names=None, device=None, class_weights=None):
        model = TabNetClassifier(input_size=n_features, num_classes=1)
        super().__init__(
            model=model,
            model_name="tabnet_binary",
            mode="binary",
            num_classes=1,
